    ...
    return(
        <div className="bg-grey backdrop-blur-10 w-full min-h-80">
            <div className='flex justify-around flex-wrap p-features'>
                ...
                <img src="/features/people.png" alt="Logo" style={{ width:'70px', marginLeft:'117px' }} className='overflow-clip' />
                ...
                <div className='block w-features'>
                <img src="/features/ruler.png" alt="Logo" style={{ width:'70px', marginLeft:'117px' }} className='overflow-clip' />
                ...
                <div className='block w-features'>
                <img src="/features/arrowUp.png" alt="Logo" style={{ width:'70px', marginLeft:'117px' }} className='overflow-clip' />
